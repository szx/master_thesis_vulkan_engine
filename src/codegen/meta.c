...
#include "../core/log.h"
void SpvAccessQualifier__debug_print(int flags) {
  log_debug("SpvAccessQualifier_: {");
  if ((flags & 0) != 0) { log_debug("  SpvAccessQualifierReadOnly"); }
  if ((flags & 1) != 0) { log_debug("  SpvAccessQualifierWriteOnly"); }
  if ((flags & 2) != 0) { log_debug("  SpvAccessQualifierReadWrite"); }
  if ((flags & 2147483647) != 0) { log_debug("  SpvAccessQualifierMax"); }
  log_debug("SpvAccessQualifier_: }");
}
...
void SpvFPFastMathModeMask__debug_print(int flags) {
  log_debug("SpvFPFastMathModeMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvFPFastMathModeMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvFPFastMathModeNotNaNMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvFPFastMathModeNotInfMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvFPFastMathModeNSZMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvFPFastMathModeAllowRecipMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvFPFastMathModeFastMask"); }
  log_debug("SpvFPFastMathModeMask_: }");
}
...
void SpvFragmentShadingRateMask__debug_print(int flags) {
  log_debug("SpvFragmentShadingRateMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvFragmentShadingRateMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvFragmentShadingRateVertical2PixelsMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvFragmentShadingRateVertical4PixelsMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvFragmentShadingRateHorizontal2PixelsMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvFragmentShadingRateHorizontal4PixelsMask"); }
  log_debug("SpvFragmentShadingRateMask_: }");
}
...
void SpvFunctionControlMask__debug_print(int flags) {
  log_debug("SpvFunctionControlMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvFunctionControlMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvFunctionControlInlineMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvFunctionControlDontInlineMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvFunctionControlPureMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvFunctionControlConstMask"); }
  log_debug("SpvFunctionControlMask_: }");
}
...
void SpvImageOperandsMask__debug_print(int flags) {
  log_debug("SpvImageOperandsMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvImageOperandsMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvImageOperandsBiasMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvImageOperandsLodMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvImageOperandsGradMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvImageOperandsConstOffsetMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvImageOperandsOffsetMask"); }
  if ((flags & 32) != 0) { log_debug("  SpvImageOperandsConstOffsetsMask"); }
  if ((flags & 64) != 0) { log_debug("  SpvImageOperandsSampleMask"); }
  if ((flags & 128) != 0) { log_debug("  SpvImageOperandsMinLodMask"); }
  if ((flags & 256) != 0) { log_debug("  SpvImageOperandsMakeTexelAvailableMask"); }
  if ((flags & 256) != 0) { log_debug("  SpvImageOperandsMakeTexelAvailableKHRMask"); }
  if ((flags & 512) != 0) { log_debug("  SpvImageOperandsMakeTexelVisibleMask"); }
  if ((flags & 512) != 0) { log_debug("  SpvImageOperandsMakeTexelVisibleKHRMask"); }
  if ((flags & 1024) != 0) { log_debug("  SpvImageOperandsNonPrivateTexelMask"); }
  if ((flags & 1024) != 0) { log_debug("  SpvImageOperandsNonPrivateTexelKHRMask"); }
  if ((flags & 2048) != 0) { log_debug("  SpvImageOperandsVolatileTexelMask"); }
  if ((flags & 2048) != 0) { log_debug("  SpvImageOperandsVolatileTexelKHRMask"); }
  if ((flags & 4096) != 0) { log_debug("  SpvImageOperandsSignExtendMask"); }
  if ((flags & 8192) != 0) { log_debug("  SpvImageOperandsZeroExtendMask"); }
  log_debug("SpvImageOperandsMask_: }");
}
...
void SpvKernelEnqueueFlags__debug_print(int flags) {
  log_debug("SpvKernelEnqueueFlags_: {");
  if ((flags & 0) != 0) { log_debug("  SpvKernelEnqueueFlagsNoWait"); }
  if ((flags & 1) != 0) { log_debug("  SpvKernelEnqueueFlagsWaitKernel"); }
  if ((flags & 2) != 0) { log_debug("  SpvKernelEnqueueFlagsWaitWorkGroup"); }
  if ((flags & 2147483647) != 0) { log_debug("  SpvKernelEnqueueFlagsMax"); }
  log_debug("SpvKernelEnqueueFlags_: }");
}
...
void SpvLoopControlMask__debug_print(int flags) {
  log_debug("SpvLoopControlMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvLoopControlMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvLoopControlUnrollMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvLoopControlDontUnrollMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvLoopControlDependencyInfiniteMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvLoopControlDependencyLengthMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvLoopControlMinIterationsMask"); }
  if ((flags & 32) != 0) { log_debug("  SpvLoopControlMaxIterationsMask"); }
  if ((flags & 64) != 0) { log_debug("  SpvLoopControlIterationMultipleMask"); }
  if ((flags & 128) != 0) { log_debug("  SpvLoopControlPeelCountMask"); }
  if ((flags & 256) != 0) { log_debug("  SpvLoopControlPartialCountMask"); }
  if ((flags & 65536) != 0) { log_debug("  SpvLoopControlInitiationIntervalINTELMask"); }
  if ((flags & 131072) != 0) { log_debug("  SpvLoopControlMaxConcurrencyINTELMask"); }
  if ((flags & 262144) != 0) { log_debug("  SpvLoopControlDependencyArrayINTELMask"); }
  if ((flags & 524288) != 0) { log_debug("  SpvLoopControlPipelineEnableINTELMask"); }
  if ((flags & 1048576) != 0) { log_debug("  SpvLoopControlLoopCoalesceINTELMask"); }
  if ((flags & 2097152) != 0) { log_debug("  SpvLoopControlMaxInterleavingINTELMask"); }
  if ((flags & 4194304) != 0) { log_debug("  SpvLoopControlSpeculatedIterationsINTELMask"); }
  log_debug("SpvLoopControlMask_: }");
}
...
void SpvMemoryAccessMask__debug_print(int flags) {
  log_debug("SpvMemoryAccessMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvMemoryAccessMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvMemoryAccessVolatileMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvMemoryAccessAlignedMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvMemoryAccessNontemporalMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvMemoryAccessMakePointerAvailableMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvMemoryAccessMakePointerAvailableKHRMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvMemoryAccessMakePointerVisibleMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvMemoryAccessMakePointerVisibleKHRMask"); }
  if ((flags & 32) != 0) { log_debug("  SpvMemoryAccessNonPrivatePointerMask"); }
  if ((flags & 32) != 0) { log_debug("  SpvMemoryAccessNonPrivatePointerKHRMask"); }
  log_debug("SpvMemoryAccessMask_: }");
}
...
void SpvMemorySemanticsMask__debug_print(int flags) {
  log_debug("SpvMemorySemanticsMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvMemorySemanticsMaskNone"); }
  if ((flags & 2) != 0) { log_debug("  SpvMemorySemanticsAcquireMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvMemorySemanticsReleaseMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvMemorySemanticsAcquireReleaseMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvMemorySemanticsSequentiallyConsistentMask"); }
  if ((flags & 64) != 0) { log_debug("  SpvMemorySemanticsUniformMemoryMask"); }
  if ((flags & 128) != 0) { log_debug("  SpvMemorySemanticsSubgroupMemoryMask"); }
  if ((flags & 256) != 0) { log_debug("  SpvMemorySemanticsWorkgroupMemoryMask"); }
  if ((flags & 512) != 0) { log_debug("  SpvMemorySemanticsCrossWorkgroupMemoryMask"); }
  if ((flags & 1024) != 0) { log_debug("  SpvMemorySemanticsAtomicCounterMemoryMask"); }
  if ((flags & 2048) != 0) { log_debug("  SpvMemorySemanticsImageMemoryMask"); }
  if ((flags & 4096) != 0) { log_debug("  SpvMemorySemanticsOutputMemoryMask"); }
  if ((flags & 4096) != 0) { log_debug("  SpvMemorySemanticsOutputMemoryKHRMask"); }
  if ((flags & 8192) != 0) { log_debug("  SpvMemorySemanticsMakeAvailableMask"); }
  if ((flags & 8192) != 0) { log_debug("  SpvMemorySemanticsMakeAvailableKHRMask"); }
  if ((flags & 16384) != 0) { log_debug("  SpvMemorySemanticsMakeVisibleMask"); }
  if ((flags & 16384) != 0) { log_debug("  SpvMemorySemanticsMakeVisibleKHRMask"); }
  if ((flags & 32768) != 0) { log_debug("  SpvMemorySemanticsVolatileMask"); }
  log_debug("SpvMemorySemanticsMask_: }");
}
...
void SpvRayFlagsMask__debug_print(int flags) {
  log_debug("SpvRayFlagsMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvRayFlagsMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvRayFlagsOpaqueKHRMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvRayFlagsNoOpaqueKHRMask"); }
  if ((flags & 4) != 0) { log_debug("  SpvRayFlagsTerminateOnFirstHitKHRMask"); }
  if ((flags & 8) != 0) { log_debug("  SpvRayFlagsSkipClosestHitShaderKHRMask"); }
  if ((flags & 16) != 0) { log_debug("  SpvRayFlagsCullBackFacingTrianglesKHRMask"); }
  if ((flags & 32) != 0) { log_debug("  SpvRayFlagsCullFrontFacingTrianglesKHRMask"); }
  if ((flags & 64) != 0) { log_debug("  SpvRayFlagsCullOpaqueKHRMask"); }
  if ((flags & 128) != 0) { log_debug("  SpvRayFlagsCullNoOpaqueKHRMask"); }
  if ((flags & 256) != 0) { log_debug("  SpvRayFlagsSkipTrianglesKHRMask"); }
  if ((flags & 512) != 0) { log_debug("  SpvRayFlagsSkipAABBsKHRMask"); }
  log_debug("SpvRayFlagsMask_: }");
}
...
void SpvRayQueryCommittedIntersectionType__debug_print(int flags) {
  log_debug("SpvRayQueryCommittedIntersectionType_: {");
  if ((flags & 0) != 0) { log_debug("  SpvRayQueryCommittedIntersectionTypeRayQueryCommittedIntersectionNoneKHR"); }
  if ((flags & 1) != 0) { log_debug("  SpvRayQueryCommittedIntersectionTypeRayQueryCommittedIntersectionTriangleKHR"); }
  if ((flags & 2) != 0) { log_debug("  SpvRayQueryCommittedIntersectionTypeRayQueryCommittedIntersectionGeneratedKHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  SpvRayQueryCommittedIntersectionTypeMax"); }
  log_debug("SpvRayQueryCommittedIntersectionType_: }");
}
...
void SpvReflectDecorationFlagBits_debug_print(int flags) {
  log_debug("SpvReflectDecorationFlagBits: {");
  if ((flags & 0) != 0) { log_debug("  SPV_REFLECT_DECORATION_NONE"); }
  if ((flags & 1) != 0) { log_debug("  SPV_REFLECT_DECORATION_BLOCK"); }
  if ((flags & 2) != 0) { log_debug("  SPV_REFLECT_DECORATION_BUFFER_BLOCK"); }
  if ((flags & 4) != 0) { log_debug("  SPV_REFLECT_DECORATION_ROW_MAJOR"); }
  if ((flags & 8) != 0) { log_debug("  SPV_REFLECT_DECORATION_COLUMN_MAJOR"); }
  if ((flags & 16) != 0) { log_debug("  SPV_REFLECT_DECORATION_BUILT_IN"); }
  if ((flags & 32) != 0) { log_debug("  SPV_REFLECT_DECORATION_NOPERSPECTIVE"); }
  if ((flags & 64) != 0) { log_debug("  SPV_REFLECT_DECORATION_FLAT"); }
  if ((flags & 128) != 0) { log_debug("  SPV_REFLECT_DECORATION_NON_WRITABLE"); }
  log_debug("SpvReflectDecorationFlagBits: }");
}
...
void SpvReflectResourceType_debug_print(int flags) {
  log_debug("SpvReflectResourceType: {");
  if ((flags & 0) != 0) { log_debug("  SPV_REFLECT_RESOURCE_FLAG_UNDEFINED"); }
  if ((flags & 1) != 0) { log_debug("  SPV_REFLECT_RESOURCE_FLAG_SAMPLER"); }
  if ((flags & 2) != 0) { log_debug("  SPV_REFLECT_RESOURCE_FLAG_CBV"); }
  if ((flags & 4) != 0) { log_debug("  SPV_REFLECT_RESOURCE_FLAG_SRV"); }
  if ((flags & 8) != 0) { log_debug("  SPV_REFLECT_RESOURCE_FLAG_UAV"); }
  log_debug("SpvReflectResourceType: }");
}
...
void SpvReflectShaderStageFlagBits_debug_print(int flags) {
  log_debug("SpvReflectShaderStageFlagBits: {");
  if ((flags & 1) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_VERTEX_BIT"); }
  if ((flags & 2) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_TESSELLATION_CONTROL_BIT"); }
  if ((flags & 4) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_TESSELLATION_EVALUATION_BIT"); }
  if ((flags & 8) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_GEOMETRY_BIT"); }
  if ((flags & 16) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_FRAGMENT_BIT"); }
  if ((flags & 32) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_COMPUTE_BIT"); }
  if ((flags & 64) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_TASK_BIT_NV"); }
  if ((flags & 128) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_MESH_BIT_NV"); }
  if ((flags & 256) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_RAYGEN_BIT_KHR"); }
  if ((flags & 512) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_ANY_HIT_BIT_KHR"); }
  if ((flags & 1024) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_CLOSEST_HIT_BIT_KHR"); }
  if ((flags & 2048) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_MISS_BIT_KHR"); }
  if ((flags & 4096) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_INTERSECTION_BIT_KHR"); }
  if ((flags & 8192) != 0) { log_debug("  SPV_REFLECT_SHADER_STAGE_CALLABLE_BIT_KHR"); }
  log_debug("SpvReflectShaderStageFlagBits: }");
}
...
void SpvSelectionControlMask__debug_print(int flags) {
  log_debug("SpvSelectionControlMask_: {");
  if ((flags & 0) != 0) { log_debug("  SpvSelectionControlMaskNone"); }
  if ((flags & 1) != 0) { log_debug("  SpvSelectionControlFlattenMask"); }
  if ((flags & 2) != 0) { log_debug("  SpvSelectionControlDontFlattenMask"); }
  log_debug("SpvSelectionControlMask_: }");
}
...
void StdVideoDecodeH264FieldOrderCount_debug_print(int flags) {
  log_debug("StdVideoDecodeH264FieldOrderCount: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_TOP"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_BOTTOM"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_LIST_SIZE"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_DECODE_H264_FIELD_ORDER_COUNT_INVALID"); }
  log_debug("StdVideoDecodeH264FieldOrderCount: }");
}
...
void StdVideoH264CabacInitIdc_debug_print(int flags) {
  log_debug("StdVideoH264CabacInitIdc: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H264_CABAC_INIT_IDC_0"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H264_CABAC_INIT_IDC_1"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H264_CABAC_INIT_IDC_2"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H264_CABAC_INIT_IDC_INVALID"); }
  log_debug("StdVideoH264CabacInitIdc: }");
}
...
void StdVideoH264DisableDeblockingFilterIdc_debug_print(int flags) {
  log_debug("StdVideoH264DisableDeblockingFilterIdc: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_DISABLED"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_ENABLED"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_PARTIAL"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H264_DISABLE_DEBLOCKING_FILTER_IDC_INVALID"); }
  log_debug("StdVideoH264DisableDeblockingFilterIdc: }");
}
...
void StdVideoH264PocType_debug_print(int flags) {
  log_debug("StdVideoH264PocType: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H264_POC_TYPE_0"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H264_POC_TYPE_1"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H264_POC_TYPE_2"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H264_POC_TYPE_INVALID"); }
  log_debug("StdVideoH264PocType: }");
}
...
void StdVideoH264SliceType_debug_print(int flags) {
  log_debug("StdVideoH264SliceType: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H264_SLICE_TYPE_P"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H264_SLICE_TYPE_B"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H264_SLICE_TYPE_I"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H264_SLICE_TYPE_INVALID"); }
  log_debug("StdVideoH264SliceType: }");
}
void StdVideoH264WeightedBipredIdc_debug_print(int flags) {
  log_debug("StdVideoH264WeightedBipredIdc: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_DEFAULT"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_EXPLICIT"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_IMPLICIT"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H264_WEIGHTED_BIPRED_IDC_INVALID"); }
  log_debug("StdVideoH264WeightedBipredIdc: }");
}
...
void StdVideoH265SliceType_debug_print(int flags) {
  log_debug("StdVideoH265SliceType: {");
  if ((flags & 0) != 0) { log_debug("  STD_VIDEO_H265_SLICE_TYPE_B"); }
  if ((flags & 1) != 0) { log_debug("  STD_VIDEO_H265_SLICE_TYPE_P"); }
  if ((flags & 2) != 0) { log_debug("  STD_VIDEO_H265_SLICE_TYPE_I"); }
  if ((flags & 2147483647) != 0) { log_debug("  STD_VIDEO_H265_SLICE_TYPE_INVALID"); }
  log_debug("StdVideoH265SliceType: }");
}
...
void VkAccelerationStructureCreateFlagBitsKHR_debug_print(int flags) {
  log_debug("VkAccelerationStructureCreateFlagBitsKHR: {");
  if ((flags & 1) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR"); }
  if ((flags & 4) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_CREATE_MOTION_BIT_NV"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_CREATE_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkAccelerationStructureCreateFlagBitsKHR: }");
}
...
void VkAccelerationStructureMotionInstanceTypeNV_debug_print(int flags) {
  log_debug("VkAccelerationStructureMotionInstanceTypeNV: {");
  if ((flags & 0) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_MOTION_INSTANCE_TYPE_STATIC_NV"); }
  if ((flags & 1) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_MOTION_INSTANCE_TYPE_MATRIX_MOTION_NV"); }
  if ((flags & 2) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_MOTION_INSTANCE_TYPE_SRT_MOTION_NV"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_ACCELERATION_STRUCTURE_MOTION_INSTANCE_TYPE_MAX_ENUM_NV"); }
  log_debug("VkAccelerationStructureMotionInstanceTypeNV: }");
}
...
void VkAccessFlagBits_debug_print(int flags) {
  ...
  if ((flags & 0) != 0) { log_debug("  VK_ACCESS_NONE_KHR"); }
...
void VkBufferUsageFlagBits_debug_print(int flags) {
  ...
  if ((flags & 8192) != 0) { log_debug("  VK_BUFFER_USAGE_VIDEO_DECODE_SRC_BIT_KHR"); }
  if ((flags & 16384) != 0) { log_debug("  VK_BUFFER_USAGE_VIDEO_DECODE_DST_BIT_KHR"); }
  ...
  if ((flags & 32768) != 0) { log_debug("  VK_BUFFER_USAGE_VIDEO_ENCODE_DST_BIT_KHR"); }
  if ((flags & 65536) != 0) { log_debug("  VK_BUFFER_USAGE_VIDEO_ENCODE_SRC_BIT_KHR"); }
...
void VkBuildAccelerationStructureFlagBitsKHR_debug_print(int flags) {
  ...
  if ((flags & 32) != 0) { log_debug("  VK_BUILD_ACCELERATION_STRUCTURE_MOTION_BIT_NV"); }
...
void VkDescriptorPoolCreateFlagBits_debug_print(int flags) {
  ...
  if ((flags & 4) != 0) { log_debug("  VK_DESCRIPTOR_POOL_CREATE_HOST_ONLY_BIT_VALVE"); }
...
void VkDescriptorSetLayoutCreateFlagBits_debug_print(int flags) {
  ...
  if ((flags & 4) != 0) { log_debug("  VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_VALVE"); }
...
void VkExternalMemoryHandleTypeFlagBits_debug_print(int flags) {
  ...
  if ((flags & 2048) != 0) { log_debug("  VK_EXTERNAL_MEMORY_HANDLE_TYPE_ZIRCON_VMO_BIT_FUCHSIA"); }
  if ((flags & 4096) != 0) { log_debug("  VK_EXTERNAL_MEMORY_HANDLE_TYPE_RDMA_ADDRESS_BIT_NV"); }
...
void VkExternalSemaphoreHandleTypeFlagBits_debug_print(int flags) {
  ...
  if ((flags & 128) != 0) { log_debug("  VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_ZIRCON_EVENT_BIT_FUCHSIA"); }
...
void VkFormatFeatureFlagBits_debug_print(int flags) {
  ...
  if ((flags & 33554432) != 0) { log_debug("  VK_FORMAT_FEATURE_VIDEO_DECODE_OUTPUT_BIT_KHR"); }
  if ((flags & 67108864) != 0) { log_debug("  VK_FORMAT_FEATURE_VIDEO_DECODE_DPB_BIT_KHR"); }
  ...
  if ((flags & 134217728) != 0) { log_debug("  VK_FORMAT_FEATURE_VIDEO_ENCODE_INPUT_BIT_KHR"); }
  if ((flags & 268435456) != 0) { log_debug("  VK_FORMAT_FEATURE_VIDEO_ENCODE_DPB_BIT_KHR"); }
...
void VkGeometryInstanceFlagBitsKHR_debug_print(int flags) {
  ...
  if ((flags & 2) != 0) { log_debug("  VK_GEOMETRY_INSTANCE_TRIANGLE_FLIP_FACING_BIT_KHR"); }
...
void VkImageUsageFlagBits_debug_print(int flags) {
  ...
  if ((flags & 1024) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR"); }
  if ((flags & 2048) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_DECODE_SRC_BIT_KHR"); }
  if ((flags & 4096) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR"); }
  ...
  if ((flags & 8192) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_ENCODE_DST_BIT_KHR"); }
  if ((flags & 16384) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR"); }
  if ((flags & 32768) != 0) { log_debug("  VK_IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR"); }
  if ((flags & 262144) != 0) { log_debug("  VK_IMAGE_USAGE_INVOCATION_MASK_BIT_HUAWEI"); }
...
void VkMemoryPropertyFlagBits_debug_print(int flags) {
  ...
  if ((flags & 256) != 0) { log_debug("  VK_MEMORY_PROPERTY_RDMA_CAPABLE_BIT_NV"); }
...
void VkPipelineCreateFlagBits_debug_print(int flags) {
  ...
  if ((flags & 2097152) != 0) { log_debug("  VK_PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR"); }
  if ((flags & 4194304) != 0) { log_debug("  VK_PIPELINE_RASTERIZATION_STATE_CREATE_FRAGMENT_DENSITY_MAP_ATTACHMENT_BIT_EXT"); }
  ...
  if ((flags & 1048576) != 0) { log_debug("  VK_PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV"); }
...
void VkPipelineStageFlagBits_debug_print(int flags) {
  ...
  if ((flags & 0) != 0) { log_debug("  VK_PIPELINE_STAGE_NONE_KHR"); }
...
void VkQueryResultFlagBits_debug_print(int flags) {
  ...
  if ((flags & 16) != 0) { log_debug("  VK_QUERY_RESULT_WITH_STATUS_BIT_KHR"); }
...
void VkQueueFlagBits_debug_print(int flags) {
  ...
  if ((flags & 32) != 0) { log_debug("  VK_QUEUE_VIDEO_DECODE_BIT_KHR"); }
  if ((flags & 64) != 0) { log_debug("  VK_QUEUE_VIDEO_ENCODE_BIT_KHR"); }
...
void VkRenderingFlagBitsKHR_debug_print(int flags) {
  log_debug("VkRenderingFlagBitsKHR: {");
  if ((flags & 1) != 0) { log_debug("  VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT_KHR"); }
  if ((flags & 2) != 0) { log_debug("  VK_RENDERING_SUSPENDING_BIT_KHR"); }
  if ((flags & 4) != 0) { log_debug("  VK_RENDERING_RESUMING_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_RENDERING_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkRenderingFlagBitsKHR: }");
}
...
void VkVideoCapabilityFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoCapabilityFlagBitsKHR: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_CAPABILITY_PROTECTED_CONTENT_BIT_KHR"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_CAPABILITY_SEPARATE_REFERENCE_IMAGES_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_CAPABILITY_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoCapabilityFlagBitsKHR: }");
}
void VkVideoChromaSubsamplingFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoChromaSubsamplingFlagBitsKHR: {");
  if ((flags & 0) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_INVALID_BIT_KHR"); }
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_MONOCHROME_BIT_KHR"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_420_BIT_KHR"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_422_BIT_KHR"); }
  if ((flags & 8) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_444_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_CHROMA_SUBSAMPLING_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoChromaSubsamplingFlagBitsKHR: }");
}
void VkVideoCodecOperationFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoCodecOperationFlagBitsKHR: {");
  if ((flags & 0) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_INVALID_BIT_KHR"); }
  if ((flags & 65536) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_EXT"); }
  if ((flags & 131072) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_EXT"); }
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_DECODE_H265_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_CODEC_OPERATION_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoCodecOperationFlagBitsKHR: }");
}
...
void VkVideoCodingQualityPresetFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoCodingQualityPresetFlagBitsKHR: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_CODING_QUALITY_PRESET_NORMAL_BIT_KHR"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_CODING_QUALITY_PRESET_POWER_BIT_KHR"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_CODING_QUALITY_PRESET_QUALITY_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_CODING_QUALITY_PRESET_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoCodingQualityPresetFlagBitsKHR: }");
}
void VkVideoComponentBitDepthFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoComponentBitDepthFlagBitsKHR: {");
  if ((flags & 0) != 0) { log_debug("  VK_VIDEO_COMPONENT_BIT_DEPTH_INVALID_KHR"); }
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_COMPONENT_BIT_DEPTH_8_BIT_KHR"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_COMPONENT_BIT_DEPTH_10_BIT_KHR"); }
  if ((flags & 16) != 0) { log_debug("  VK_VIDEO_COMPONENT_BIT_DEPTH_12_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_COMPONENT_BIT_DEPTH_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoComponentBitDepthFlagBitsKHR: }");
}
...
void VkVideoDecodeH264PictureLayoutFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoDecodeH264PictureLayoutFlagBitsEXT: {");
  if ((flags & 0) != 0) { log_debug("  VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_PROGRESSIVE_EXT"); }
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_INTERLACED_INTERLEAVED_LINES_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_INTERLACED_SEPARATE_PLANES_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoDecodeH264PictureLayoutFlagBitsEXT: }");
}
...
void VkVideoEncodeH264CapabilityFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH264CapabilityFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_CABAC_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_CAVLC_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_WEIGHTED_BI_PRED_IMPLICIT_BIT_EXT"); }
  if ((flags & 8) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8_BIT_EXT"); }
  if ((flags & 16) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_CHROMA_QP_OFFSET_BIT_EXT"); }
  if ((flags & 32) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_SECOND_CHROMA_QP_OFFSET_BIT_EXT"); }
  if ((flags & 64) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED_BIT_EXT"); }
  if ((flags & 128) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED_BIT_EXT"); }
  if ((flags & 256) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL_BIT_EXT"); }
  if ((flags & 512) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_MULTIPLE_SLICE_PER_FRAME_BIT_EXT"); }
  if ((flags & 1024) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_EVENLY_DISTRIBUTED_SLICE_SIZE_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_CAPABILITY_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH264CapabilityFlagBitsEXT: }");
}
...
void VkVideoEncodeH264InputModeFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH264InputModeFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_INPUT_MODE_FRAME_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_INPUT_MODE_SLICE_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_INPUT_MODE_NON_VCL_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_INPUT_MODE_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH264InputModeFlagBitsEXT: }");
}
void VkVideoEncodeH264OutputModeFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH264OutputModeFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FRAME_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_OUTPUT_MODE_SLICE_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_OUTPUT_MODE_NON_VCL_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH264OutputModeFlagBitsEXT: }");
}
void VkVideoEncodeH265CtbSizeFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH265CtbSizeFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_CTB_SIZE_8_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_CTB_SIZE_16_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_CTB_SIZE_32_BIT_EXT"); }
  if ((flags & 8) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_CTB_SIZE_64_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_CTB_SIZE_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH265CtbSizeFlagBitsEXT: }");
}
void VkVideoEncodeH265InputModeFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH265InputModeFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_INPUT_MODE_SLICE_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_INPUT_MODE_NON_VCL_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_INPUT_MODE_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH265InputModeFlagBitsEXT: }");
}
void VkVideoEncodeH265OutputModeFlagBitsEXT_debug_print(int flags) {
  log_debug("VkVideoEncodeH265OutputModeFlagBitsEXT: {");
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_OUTPUT_MODE_SLICE_BIT_EXT"); }
  if ((flags & 4) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_OUTPUT_MODE_NON_VCL_BIT_EXT"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FLAG_BITS_MAX_ENUM_EXT"); }
  log_debug("VkVideoEncodeH265OutputModeFlagBitsEXT: }");
}
...
void VkVideoEncodeRateControlModeFlagBitsKHR_debug_print(int flags) {
  log_debug("VkVideoEncodeRateControlModeFlagBitsKHR: {");
  if ((flags & 0) != 0) { log_debug("  VK_VIDEO_ENCODE_RATE_CONTROL_MODE_NONE_BIT_KHR"); }
  if ((flags & 1) != 0) { log_debug("  VK_VIDEO_ENCODE_RATE_CONTROL_MODE_CBR_BIT_KHR"); }
  if ((flags & 2) != 0) { log_debug("  VK_VIDEO_ENCODE_RATE_CONTROL_MODE_VBR_BIT_KHR"); }
  if ((flags & 2147483647) != 0) { log_debug("  VK_VIDEO_ENCODE_RATE_CONTROL_MODE_FLAG_BITS_MAX_ENUM_KHR"); }
  log_debug("VkVideoEncodeRateControlModeFlagBitsKHR: }");
}
