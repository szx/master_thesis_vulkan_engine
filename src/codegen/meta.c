...
const char *vulkan_batch_policy_debug_str(int value) {
  if (value == 0) { return "vulkan_batch_policy_none"; }
  if (value == 1) { return "vulkan_batch_policy_matching_materials"; }
  if (value == 2) { return "vulkan_batch_policy_matching_vertex_attributes"; }
  return "UNKNOWN vulkan_batch_policy";
}
