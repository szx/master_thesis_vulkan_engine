...
#define decl_data_select(_type, _value, ...)                                                       \
  data_##_type sql_db_select_##_type(sql_db *db, char *table, data_key key, char *column);         \
  data_##_type##_array sql_db_select_##_type##_array(sql_db *db, char *table, data_key key,        \
                                                     char *column);
