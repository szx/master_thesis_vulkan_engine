...
int main(int argc, char *argv[]) {
  ...
  vulkan_pipeline_type pipelines[] = {
      vulkan_pipeline_type_skybox, vulkan_pipeline_type_deferred_geometry,
      vulkan_pipeline_type_forward, vulkan_pipeline_type_debug_text};
