...
typedef struct vulkan_scene_render_context {
...
} vulkan_scene_render_context;

vulkan_scene_render_context *vulkan_scene_render_context_create(data_asset_db *assetDb,
                                                                vulkan_device *vkd,
                                                                UT_string *sceneName);
void vulkan_scene_render_context_destroy(vulkan_scene_render_context *renderData);

void vulkan_scene_render_context_build_geometry_buffer(
    vulkan_scene_render_context *renderData); // TODO move to separate header
/// Update scene data on CPU. Can make camera and uniform buffer dirty.
void vulkan_scene_render_context_update_data(vulkan_scene_render_context *renderData);
void vulkan_scene_render_context_send_to_device(vulkan_scene_render_context *renderData);

void vulkan_scene_render_context_debug_print(vulkan_scene_render_context *renderData);
