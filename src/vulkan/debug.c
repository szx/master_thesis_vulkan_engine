...
VULKAN_DEBUG_NAME_FUNC_DEF(sampler, VkSampler, VK_OBJECT_TYPE_SAMPLER)
...
VULKAN_DEBUG_NAME_FUNC_DEF(render_pass, VkRenderPass, VK_OBJECT_TYPE_RENDER_PASS)
VULKAN_DEBUG_NAME_FUNC_DEF(graphics_pipeline, VkPipeline, VK_OBJECT_TYPE_PIPELINE)
