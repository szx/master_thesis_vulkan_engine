...
render_state_create(swap_chain *vks, renderer_cache *rendererCache, data_config *config,
  ...
  renderState->updateUnifiedConstantBufferFunc = updateUnifiedConstantBufferFunc;
  ...
  renderState->unifiedUniformBuffer = unified_constant_buffer_create(
...
void render_state_destroy(render_state *renderState) {
  ...
  unified_constant_buffer_destroy(renderState->unifiedUniformBuffer);
...
void render_state_update(render_state *renderState, void *updateUnifiedConstantBufferFuncData) {
  ...
  unified_constant_buffer_update(renderState->unifiedUniformBuffer, renderState->sync,
                                 renderState->updateUnifiedConstantBufferFunc,
                                 updateUnifiedConstantBufferFuncData);
...
void render_state_send_to_device(render_state *renderState) {
  ...
  unified_constant_buffer_send_to_device(renderState->unifiedUniformBuffer);
...
void render_state_debug_print(render_state *renderState) {
  ...
  unified_constant_buffer_debug_print(renderState->unifiedUniformBuffer);
