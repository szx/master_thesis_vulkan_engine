...
vulkan_render_pass_light_state_create(vulkan_render_state *renderState) {
  vulkan_render_pass_light_state *lights = core_alloc(sizeof(vulkan_render_pass_light_state));
...
void vulkan_render_pass_light_state_debug_print(vulkan_render_pass_light_state *lights,
                                                int indent) {
