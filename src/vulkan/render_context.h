...
typedef struct vulkan_pipeline {
  vulkan_device *vkd;                 /// vulkan_device pointer.
  vulkan_swap_chain *vks;             /// vulkan_swap_chain pointer.
  vulkan_scene_render_context *scene; /// parent scene pointer
...
vulkan_pipeline *vulkan_pipeline_create(vulkan_swap_chain *vks, vulkan_scene_render_context *scene);
...
typedef struct vulkan_render_context {
  ...
  vulkan_scene_render_context *scene;                  /// Vulkan scene.
