...
Nagrywane polecenia mogą być podzielone na dwa rodzaje: HIRO
// HIRO Rodzaje poleceń: zmiana stanu (dowiązywanie), rysowanie

Bufor poleceń przechodzi w stan wykonywalny po wywołaniu funkcji \textit{vkEndCommandBuffer()} kończącej nagrywanie. 

// HIRO vkQueueSubmit() wysyłane do kolejki w celu wykonania na GPU




// HIRO ponowne użycie vs nagrywanie co klatkę
