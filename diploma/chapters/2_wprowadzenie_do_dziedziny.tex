...
// TODO vkPipeline - potok graficzny

// TODO vkShaderModule - shadery
...
Zasoby można podzielić na zasoby wejściowe i wyjściowe.
...
Liczba możliwych elementów składającymi się na zasób 3D skłoniła branżę do opracowania ustandaryzowanych formatów opisu sceny, wśród których szczególną popularność zdobyły \textit{USD} (Universal Scene Description), który jest rozwijany przez Pixar i pozwala na łatwą i kompletną wymianę informacji pomiędzy różnymi programami grafiki 3D, oraz \textit{glTF} (GL Transmission Format), który jest rozwijany przez Khronos i jest przystosowany do przechowywania ostatecznej wersji sceny w sposób prosty do sparsowania i wyrenderowania bądź dalszego przetworzenia.
...
Przepływ pracy dla zasobów jest przedstawiony na poniższym diagramie:
\begin{figure}[H]
	\centering
...
// HIRO https://docs.unity3d.com/2020.1/Documentation/Manual/AssetDatabase.html
