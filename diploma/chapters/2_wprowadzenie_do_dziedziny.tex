...
\begin{figure}[htbp]
	...
	\caption{Obraz 2D 1024x1024 z modelu Sponza \cite{GLTFSAMPLEMODELS} i jego 10 mipmap (opracowanie własne)}
	\label{mipmap}
\end{figure}
...
\subsection {Częściowo dowiązane deskryptory}
...
\subsection {Nieograniczone tablice deskryptorów}
