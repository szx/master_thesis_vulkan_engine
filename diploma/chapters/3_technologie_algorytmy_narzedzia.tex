...
// HIRO cele dotyczące funkcjonalności

Obecnie silnik składa się z następujących modułów:
// HIRO lista modułów, podkatalog i przeznaczenie
...
Poniższy diagram przedstawia moduły silnika i ich najważniejsze jednostki:
\begin{figure}[H]
	\centering
...
Listing \ref{textureSampling} przedstawia przykładowy sposób dostępu do materiału podczas renderowania przykładowej sceny.
\lstset{language=GLSL}
\begin{lstlisting}[caption={Przykład dostępu do materiału podczas renderowania przykładowej sceny},captionpos=b,label={textureSampling}]
...
\subsubsection{Deskryptory descriptor}
Obiekt \textit{descriptor} reprezentuje 
// HIRO
...
\subsubsection{Generator shaderów shader\_generator}

// HIRO shader\_generator
...
// HIRO Renderer to moduł zawierajacy 

// HIRO pamięć podręczna renderera renderer\_cache
