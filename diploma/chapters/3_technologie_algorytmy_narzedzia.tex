...
\subsubsection{Jednostka db}
Obiekt \textit{db} reprezentujący połączenie z plikiem bazy danych SQLite.
...
Obiekt \textit{db} pozwala na przeprowadzanie standardowych operacji wyboru (ang. select) i umieszczania (ang. insert) rekordów do wybranej tabeli.
Baza danych SQLite wciąż wewnętrznie używa typów prostych, ale wygenerowane przy użyciu X makro metody \textit{} automatycznie przeprowadza serializację i deserializację typów złożonych.

// HIRO asset\_db

\subsection{Zasoby}

// TODO Zasoby to moduł zawierajacy struktury reprezentujące ...
