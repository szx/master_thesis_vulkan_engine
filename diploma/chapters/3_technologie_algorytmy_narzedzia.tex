...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Relacje pomiędzy obiektami zasobów w silniku}
...
Zasób siatki \textit{asset\_mesh} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_primitive}}
Zasób prymitywu \textit{asset\_primitive} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_vertex\_attribute}}
Zasób atributu wierzchołka \textit{asset\_vertex\_attribute} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_camera}}
Zasób kamery \textit{asset\_camera} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_direct\_light}}
Zasób światła bezpośredniego \textit{asset\_direct\_light} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_skybox}}
Zasób skybox \textit{asset\_skybox} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_font}}
Zasób czcionki \textit{asset\_font} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_material}}
Zasób materiału \textit{asset\_material} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_texture}}
Zasób tekstury \textit{asset\_texture} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_image}}
Zasób obrazu \textit{asset\_image} jest HIRO

\subsubsection{Zasób siatki \textit{asset\_sampler}}
Zasób próbnika \textit{asset\_sampler} jest HIRO
